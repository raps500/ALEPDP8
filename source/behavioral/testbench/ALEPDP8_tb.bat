...
echo --
echo --
rem echo Analyze Disassembler PDP8A
rem ghdl -a --ieee=synopsys --std=08 ..\rtl\ALEPDP8DIS.vhdl
...
if errorlevel == 1 goto error
echo Analyze TB
ghdl -a --ieee=synopsys --std=08 ALEPDP8_tb.vhdl
if errorlevel == 1 goto error
echo Elaborate phase
ghdl -e --ieee=synopsys --std=08 ALEPDP8_tb
echo Run simulation
if errorlevel == 1 goto error
ghdl -r --ieee=synopsys --std=08 ALEPDP8_tb --vcd=ALEPDP8_tb.vcd --stop-time=2us
:error
